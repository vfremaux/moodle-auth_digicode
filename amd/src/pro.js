...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var digicodepro = {
        ...
        component: 'auth_digicode',
        shortcomponent: 'auth_digicode',
        componentpath: 'auth/digicode',

        init: function() {

            var licensekeyid = '#id_s_' + digicodepro.component + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + digicodepro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            var calculated = digicodepro.checksum(payload);
            ...
            if (crc === calculated) {
                var url = cfg.wwwroot + '/' + digicodepro.componentpath + '/pro/ajax/services.php?';
                url += 'what=license';
                url += '&service=check';
                url += '&customerkey=' + that.val();
                url += '&provider=' + $('#id_s_' + digicodepro.component + '_licenseprovider').val();
