 ...
 * @copyright    (C) 2018 onwards Valery Fremaux (http://www
 ...
 */
function auth_digicode_compile_mail_template($template, $infomap, $lang = '') {
    global $USER;
    ...
    $notification = auth_digicode_get_mail_template($template, $lang);
 ...
 */
function auth_digicode_get_mail_template($virtual, $lang = '') {
