...
require_once($CFG->dirroot.'/auth/digicode/lib.php'); // to get xx_supports_feature();
if ('pro' == auth_digicode_supports_feature()) {
    include($CFG->dirroot.'/auth/digicode/pro/lang/fr/pro.php');
}
